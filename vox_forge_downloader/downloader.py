...
def download_corpus(target_directory: str,
                    max_workers: int,
                    amount: int,
                    voxforge_url="http://www.repository.voxforge1.org/downloads/en/Trunk/Audio/Main/16kHz_16bit/"):
    """
...
if __name__ == '__main__':
    ...
    # parser.add_argument('-l', '--language',help = 'language to download [en,es,it,fr,ru,de]')
    # args = parser.parse_args()

    # vox_directory =f'http://www.repository.voxforge1.org/downloads/{args.language}/Trunk/Audio/Main/16kHz_16bit/'
    # download_corpus(args.directory, args.workers, args.number,vox_directory)
    download_corpus('DE', 10, 800,
                    f'http://www.repository.voxforge1.org/downloads/de/Trunk/Audio/Main/16kHz_16bit/')
